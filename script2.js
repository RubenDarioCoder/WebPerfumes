...
function agregarProducto(productos, contenedor, esOferta = false) {
    productos.forEach(producto => {
        ...
        // Botón de Email
        let buttonPedirE = document.createElement('button');
        buttonPedirE.textContent = 'Pedir por Email';
        buttonPedirE.classList.add('buttonPedirE');
        ...
        divButton.appendChild(buttonPedirE);
